...
DATAPOINTS = [
    DP(key="area_a",     sec="area",   id=1,  name="area A",     pf="alm", flag="e,none",  rpath="area[idx=0]",    spath="area[id=1].status",   fmt="b",  unit="",  opt={}),
    DP(key="area_b",     sec="area",   id=2,  name="area B",     pf="alm", flag="e,none",  rpath="area[idx=1]",    spath="area[id=2].status",   fmt="b",  unit="",  opt={}),
    DP(key="area_c",     sec="area",   id=3,  name="area C",     pf="alm", flag="e,none",  rpath="area[idx=2]",    spath="area[id=3].status",   fmt="b",  unit="",  opt={}),
    DP(key="area_d",     sec="area",   id=4,  name="area D",     pf="alm", flag="e,none",  rpath="area[idx=3]",    spath="area[id=4].status",   fmt="b",  unit="",  opt={}),
    DP(key="area_e",     sec="area",   id=5,  name="area E",     pf="alm", flag="e,none",  rpath="area[idx=4]",    spath="area[id=5].status",   fmt="b",  unit="",  opt={}),
    DP(key="area_f",     sec="area",   id=6,  name="area F",     pf="alm", flag="e,none",  rpath="area[idx=5]",    spath="area[id=6].status",   fmt="b",  unit="",  opt={}),
    DP(key="area_g",     sec="area",   id=7,  name="area G",     pf="alm", flag="e,none",  rpath="area[idx=6]",    spath="area[id=7].status",   fmt="b",  unit="",  opt={}),
    DP(key="area_h",     sec="area",   id=8,  name="area H",     pf="alm", flag="e,none",  rpath="area[idx=7]",    spath="area[id=8].status",   fmt="b",  unit="",  opt={}),
    DP(key="area_i",     sec="area",   id=9,  name="area I",     pf="alm", flag="e,none",  rpath="area[idx=8]",    spath="area[id=9].status",   fmt="b",  unit="",  opt={}),
    DP(key="area_j",     sec="area",   id=10, name="area J",     pf="alm", flag="e,none",  rpath="area[idx=9]",    spath="area[id=10].status",  fmt="b",  unit="",  opt={}),
    DP(key="area_k",     sec="area",   id=11, name="area K",     pf="alm", flag="e,none",  rpath="area[idx=10]",   spath="area[id=11].status",  fmt="b",  unit="",  opt={}),
    DP(key="area_l",     sec="area",   id=12, name="area L",     pf="alm", flag="e,none",  rpath="area[idx=11]",   spath="area[id=12].status",  fmt="b",  unit="",  opt={}),
    DP(key="area_m",     sec="area",   id=13, name="area M",     pf="alm", flag="e,none",  rpath="area[idx=12]",   spath="area[id=13].status",  fmt="b",  unit="",  opt={}),
    DP(key="area_n",     sec="area",   id=14, name="area N",     pf="alm", flag="e,none",  rpath="area[idx=13]",   spath="area[id=14].status",  fmt="b",  unit="",  opt={}),
    DP(key="area_o",     sec="area",   id=15, name="area O",     pf="alm", flag="e,none",  rpath="area[idx=14]",   spath="area[id=15].status",  fmt="b",  unit="",  opt={}),
    DP(key="area_p",     sec="area",   id=16, name="area P",     pf="alm", flag="e,none",  rpath="area[idx=15]",   spath="area[id=16].status",  fmt="b",  unit="",  opt={}),

    DP(key="sensor_1",   sec="input",  id=1,  name="Sensor 1",   pf="bin", flag="e,none",  rpath="input[idx=0]",   spath="input[id=1].status",  fmt="b",  unit="",  opt={}),
    DP(key="sensor_2",   sec="input",  id=2,  name="Sensor 2",   pf="bin", flag="e,none",  rpath="input[idx=1]",   spath="input[id=2].status",  fmt="b",  unit="",  opt={}),
    DP(key="sensor_3",   sec="input",  id=3,  name="Sensor 3",   pf="bin", flag="e,none",  rpath="input[idx=2]",   spath="input[id=3].status",  fmt="b",  unit="",  opt={}),
    DP(key="sensor_4",   sec="input",  id=4,  name="Sensor 4",   pf="bin", flag="e,none",  rpath="input[idx=3]",   spath="input[id=4].status",  fmt="b",  unit="",  opt={}),
    DP(key="sensor_5",   sec="input",  id=5,  name="Sensor 5",   pf="bin", flag="e,none",  rpath="input[idx=4]",   spath="input[id=5].status",  fmt="b",  unit="",  opt={}),
    DP(key="sensor_6",   sec="input",  id=6,  name="Sensor 6",   pf="bin", flag="e,none",  rpath="input[idx=5]",   spath="input[id=6].status",  fmt="b",  unit="",  opt={}),
    DP(key="sensor_7",   sec="input",  id=7,  name="Sensor 7",   pf="bin", flag="e,none",  rpath="input[idx=6]",   spath="input[id=7].status",  fmt="b",  unit="",  opt={}),
    DP(key="sensor_8",   sec="input",  id=8,  name="Sensor 8",   pf="bin", flag="e,none",  rpath="input[idx=7]",   spath="input[id=8].status",  fmt="b",  unit="",  opt={}),
    DP(key="sensor_9",   sec="input",  id=9,  name="Sensor 9",   pf="bin", flag="e,none",  rpath="input[idx=8]",   spath="input[id=9].status",  fmt="b",  unit="",  opt={}),
    DP(key="sensor_10",  sec="input",  id=10, name="Sensor 10",  pf="bin", flag="e,none",  rpath="input[idx=9]",   spath="input[id=10].status", fmt="b",  unit="",  opt={}),
    DP(key="sensor_11",  sec="input",  id=11, name="Sensor 11",  pf="bin", flag="e,none",  rpath="input[idx=10]",  spath="input[id=11].status", fmt="b",  unit="",  opt={}),
    DP(key="sensor_12",  sec="input",  id=12, name="Sensor 12",  pf="bin", flag="e,none",  rpath="input[idx=11]",  spath="input[id=12].status", fmt="b",  unit="",  opt={}),
    DP(key="sensor_13",  sec="input",  id=13, name="Sensor 13",  pf="bin", flag="e,none",  rpath="input[idx=12]",  spath="input[id=13].status", fmt="b",  unit="",  opt={}),
    ...
    DP(key="control_3",  sec="output", id=3,  name="Control 3",  pf="sw",  flag="e,none",  rpath="output[idx=2]",  spath="output[id=3].status",  fmt="b",  unit="",  opt={}),
    DP(key="control_4",  sec="output", id=4,  name="Control 4",  pf="sw",  flag="e,none",  rpath="output[idx=3]",  spath="output[id=4].status",  fmt="b",  unit="",  opt={}),
    DP(key="control_5",  sec="output", id=5,  name="Control 5",  pf="sw",  flag="e,none",  rpath="output[idx=4]",  spath="output[id=5].status",  fmt="b",  unit="",  opt={}),
    DP(key="control_6",  sec="output", id=6,  name="Control 6",  pf="sw",  flag="e,none",  rpath="output[idx=5]",  spath="output[id=6].status",  fmt="b",  unit="",  opt={}),
    DP(key="control_7",  sec="output", id=7,  name="Control 7",  pf="sw",  flag="e,none",  rpath="output[idx=6]",  spath="output[id=7].status",  fmt="b",  unit="",  opt={}),
    DP(key="control_8",  sec="output", id=8,  name="Control 8",  pf="sw",  flag="e,none",  rpath="output[idx=7]",  spath="output[id=8].status",  fmt="b",  unit="",  opt={}),
    DP(key="control_9",  sec="output", id=9,  name="Control 9",  pf="sw",  flag="e,none",  rpath="output[idx=8]",  spath="output[id=9].status",  fmt="b",  unit="",  opt={}),
    DP(key="control_10", sec="output", id=10, name="Control 10", pf="sw",  flag="e,none",  rpath="output[idx=9]",  spath="output[id=10].status", fmt="b",  unit="",  opt={}),
    DP(key="control_11", sec="output", id=11, name="Control 11", pf="sw",  flag="e,none",  rpath="output[idx=10]", spath="output[id=11].status", fmt="b",  unit="",  opt={}),
    DP(key="control_12", sec="output", id=12, name="Control 12", pf="sw",  flag="e,none",  rpath="output[idx=11]", spath="output[id=12].status", fmt="b",  unit="",  opt={}),
    DP(key="control_13", sec="output", id=13, name="Control 13", pf="sw",  flag="e,none",  rpath="output[idx=12]", spath="output[id=13].status", fmt="b",  unit="",  opt={}),
    DP(key="control_14", sec="output", id=14, name="Control 14", pf="sw",  flag="e,none",  rpath="output[idx=13]", spath="output[id=14].status", fmt="b",  unit="",  opt={}),
    DP(key="control_15", sec="output", id=15, name="Control 15", pf="sw",  flag="e,none",  rpath="output[idx=14]", spath="output[id=15].status", fmt="b",  unit="",  opt={}),
    DP(key="control_16", sec="output", id=16, name="Control 16", pf="sw",  flag="e,none",  rpath="output[idx=15]", spath="output[id=16].status", fmt="b",  unit="",  opt={}),

    DP(key="tamper",     sec="tamper", id=0,  name="tamper",     pf="bin", flag="e,none",  rpath="=tamper",        spath="tamper.status",        fmt="b",  unit="",  opt={}),
    DP(key="system",     sec="system", id=0,  name="system",     pf="bin", flag="e,none",  rpath="=system",        spath="system.status",        fmt="b",  unit="",  opt={}),
]
